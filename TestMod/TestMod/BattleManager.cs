...
namespace Plugin.Squancher.TestMod
{
    ...
    public class BattleManager : MonoBehaviour
    {
        ...
        public void RewardScreen()
        {
            ...
            GUIManager.getInstance().DrawTextCenteredBlack(new Rect(location6.xMin + 8f, location6.yMin + 30f, location6.width - 16f, 110f), "You got stuff?!?!");
        ...
        public void Reward()
        {
            ...
            **********/
            ...
            if (invasion == "wolf")
            {
                ...
                GUI.DrawTexture(new Rect(Screen.width / 2 - 32f, Screen.height / 2 + 55f, 22f, 22f), animalRawMats.icon);

                animalRawMats = Resource.FromID(this.guiMgr.rawMatsSortType[10]);
                GUI.DrawTexture(new Rect(Screen.width / 2 - 0f, Screen.height / 2 + 55f, 22f, 22f), animalRawMats.icon);
            ...
            else
            {
                if (bounty1 > 0.8f)
                {
                    ...
                    GUI.DrawTexture(new Rect(Screen.width / 2 + 16f, Screen.height / 2 + 88f, 22f, 22f), weapons.icon);
                    GUIManager.getInstance().DrawTextLeftWhite(new Rect(Screen.width / 2 + 16f, Screen.height / 2 + 88f, 60f, 32f), "100");
                }
                if (bounty2 > 0.8f)
                {
                    Resource armor = Resource.FromID(this.guiMgr.armorSortType[reward2]);
                    GUI.DrawTexture(new Rect(Screen.width / 2 + 49f, Screen.height / 2 + 88f, 22f, 22f), armor.icon);
                }
                Resource rawMats = Resource.FromID(this.guiMgr.rawMatsSortType[0]);
                GUI.DrawTexture(new Rect(Screen.width / 2, Screen.height / 2 + 88f, 22f, 22f), rawMats.icon);
                GUIManager.getInstance().DrawTextLeftWhite(new Rect(Screen.width / 2 + 15f, Screen.height / 2 + 88f, 60f, 22f), "100");
                

                Resource pMats = Resource.FromID(this.guiMgr.indexesProcessedMats[0]);
                GUI.DrawTexture(new Rect(Screen.width / 2 - 75f, Screen.height / 2 + 88f, 22f, 22f), pMats.icon);
                GUIManager.getInstance().DrawTextLeftWhite(new Rect(Screen.width / 2 - 30f, Screen.height / 2 + 88f, 60f, 22f), "100");
